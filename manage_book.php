...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($edit_id > 0) {
        ...
        // Insert new book
        $pdo->prepare("
            INSERT INTO books (title, author, price, stock, rating, cover_image)
            VALUES (:title, :author, :price, :stock, :rating, :cover_image)
        ")->execute([
            'title'       => $title,
            'author'      => $author,
            'price'       => $price,
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="manage_book.php?delete=<?php echo $book['id']; ?>" class="btn btn-sm btn-danger"
